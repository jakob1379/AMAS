...
The files are:
MC_SigBkgElectrons_2000000ev.csv
MC_SigBkgElectrons_500000ev.csv
Actually the new file is MC_SigBkgElectrons_500K_FixedTruth.csv and is posted on the Advanced Methods in Applied Statistics 2018 website
...
Those with a "*" are those which are NOT included in the likelihood PID (LH_value).
