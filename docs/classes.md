...
* In the morning we will have the oral presentations from the articles chosen. Links to the presentations can be found on the [2018 Student Presentations page](StudentPresentations2018.md).
